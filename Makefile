...
install:
	...
	ppm --fix-conflict --no-prompt --install="build/net.intellivoid.lydia_chat_bot.ppm" --branch="production"
...
stop:
	...
	pkill -f 'main=net.intellivoid.lydia_chat_bot'
...
debug:
	...
	make stop
	screen -dm bash -c 'ppm --main="net.intellivoid.lydia_chat_bot" --version="latest"'
	sleep 3
	make stop_workers
